...
Dim rs As Recordset
    '========MReset
      ...
      strqry = "SELECT SUM(Subtotal) AS Subtotal1, SUM(DiscIntern) AS DiscNota1, SUM(Pembulatan) AS Pembulatan1, SUM(Subtotal-DiscIntern-Pembulatan) AS Total1, SUM(Voucher) AS Voucher1," & vbCrLf & _
               ...
               " (SELECT SUM(MSales.HargaTotal-(MSales.SubTotal-MSales.DiscIntern-MSales.Pembulatan)) FROM MSales WHERE IDBank=2 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= " & NamaShiftReset & ") AS Charge1, " & vbCrLf & _
...
'      strqry = "SELECT SUM(Subtotal) AS Subtotal1, SUM(DiscIntern) AS DiscNota1, SUM(Pembulatan) AS Pembulatan1, SUM(Subtotal-DiscIntern-Pembulatan) AS Total1, SUM(Voucher) AS Voucher1," & vbCrLf & _
'               " SUM(HargaTotal-Bank-Voucher) AS Tunai1," & vbCrLf & _
'               " (SELECT SUM(BANK) FROM MSales WHERE IDBank=1 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS Debet," & vbCrLf & _
'               " (SELECT SUM(MSales.BANK-(MSales.HargaTotal-(MSales.SubTotal-MSales.DiscIntern-MSales.Pembulatan))) FROM MSales WHERE IDBank=2 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS Kredit," & vbCrLf & _
'               " (SELECT SUM((MSales.BANK-(MSales.HargaTotal-(MSales.SubTotal-MSales.DiscIntern-MSales.Pembulatan)))*MSales.Charge/100) FROM MSales WHERE IDBank=2 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS Charge1," & vbCrLf & _
'               " (SELECT COUNT(NoID) FROM MSales WHERE Subtotal>0 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS JumNota," & vbCrLf & _
'               " (SELECT SUM(BANK) FROM MSales WHERE IDJenisKartu=5 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS DebetMandiri," & vbCrLf & _
'               " (SELECT Count(BANK) FROM MSales WHERE IDJenisKartu=5 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS CountDebetMandiri," & vbCrLf & _
'               " (SELECT SUM(BANK) FROM MSales WHERE IDJenisKartu=3 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS DebetBCA," & vbCrLf & _
'               " (SELECT COUNT(BANK) FROM MSales WHERE IDJenisKartu=3 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS CountDebetBCA," & vbCrLf & _
'               " (SELECT SUM(BANK) FROM MSales WHERE IDJenisKartu=6 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS DebetLain," & vbCrLf & _
'               " (SELECT Count(BANK) FROM MSales WHERE IDJenisKartu=6 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS CountDebetLain," & vbCrLf & _
'               " (SELECT SUM((MSales.BANK-(MSales.HargaTotal-(MSales.SubTotal-MSales.DiscIntern-MSales.Pembulatan)))*(100-CHARGE)/100) FROM MSales WHERE IDBank=2 AND IDJenisKartu=1 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS CreditVisa," & vbCrLf & _
'               " (SELECT COUNT(BANK) FROM MSales WHERE IDBank=2 AND IDJenisKartu=1 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS CountCreditVisa," & vbCrLf & _
'               " (SELECT SUM((MSales.BANK-(MSales.HargaTotal-(MSales.SubTotal-MSales.DiscIntern-MSales.Pembulatan)))*(100-CHARGE)/100) FROM MSales WHERE IDBank=2 AND IDJenisKartu=2 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS CreditMaster," & vbCrLf & _
'               " (SELECT Count(BANK) FROM MSales WHERE IDBank=2 AND IDJenisKartu=2 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS CountCreditMaster," & vbCrLf & _
'               " (SELECT SUM((MSales.BANK-(MSales.HargaTotal-(MSales.SubTotal-MSales.DiscIntern-MSales.Pembulatan)))*(100-CHARGE)/100) FROM MSales WHERE IDBank=2 AND IDJenisKartu=4 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS CreditBCA," & vbCrLf & _
'               " (SELECT Count(BANK) FROM MSales WHERE IDBank=2 AND IDJenisKartu=4 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS CountCreditBCA," & vbCrLf & _
'               " (SELECT SUM((MSales.BANK-(MSales.HargaTotal-(MSales.SubTotal-MSales.DiscIntern-MSales.Pembulatan)))*(100-CHARGE)/100) FROM MSales WHERE IDBank=2 AND  IDJenisKartu<>1 AND IDJenisKartu<>2 AND  IDJenisKartu<>4  AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS CreditLain," & vbCrLf & _
'               " (SELECT Count(BANK) FROM MSales WHERE IDBank=2 AND IDJenisKartu<>1 AND IDJenisKartu<>2 AND  IDJenisKartu<>4 AND Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & " AND Shift= 1) AS CountCreditLain," & vbCrLf & _
'               " (SELECT SUM(MSalesD.Jumlah) FROM MSales INNER JOIN MSalesD ON MSalesD.IDSales=MSales.NoID WHERE UCASE(MSalesD.Transaksi)='RTN' AND Day(MSales.Tanggal)=" & DayReset & " AND Month(MSales.Tanggal)=" & MonthReset & " AND Year(MSales.Tanggal)=" & YearReset & " AND MSales.Shift= 1) AS Retur" & vbCrLf & _
'               " From MSales" & vbCrLf & _
'               " WHERE Day(Tanggal)=" & DayReset & " AND Month(Tanggal)=" & MonthReset & " AND Year(Tanggal)=" & YearReset & ""
      Set rs = dbs.OpenRecordset(strqry)
